...
const FinalExamSubmit = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const response = await axios.post(`http://localhost:8000/blog/final-exam-submit/${userId}/${groupId}/`, postData);
...
export default FinalExamSubmit;
